...
void bind_se2(nb::module_& m) {
  nb::class_<PySE2>(m, "SE2",
      ...
      .def(nb::init<double, double, double, const std::string&, double, double, double, double>(),
           nb::arg("wx") = 1.0, nb::arg("wy") = 1.0, nb::arg("wtheta") = 1.0,
           nb::arg("retraction") = "exponential", nb::arg("x_lo") = 0.0, nb::arg("x_hi") = 10.0,
      ...
      .def("distance", &PySE2::distance, nb::arg("p"), nb::arg("q"), "Geodesic distance d(p, q).")
